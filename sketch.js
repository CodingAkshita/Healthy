...
function draw() {
  ...
  if (gameState === "about") {
    ...
    strokeWeight(2)
    fill("yellow")
    text(" Hey There!", (popbox.x - (popbox.width/3.8)), 110)
    text("\n  The Game Is About Healthy Eating Habits.", (popbox.x- (popbox.width/1.36)), 120)
    text("\n Level 1", (popbox.x- (popbox.width/1.36)), 120)
    //Level 1
    //The player jumps if you press the Up Arrow Key
    //Try your best to make the player eat the healthy food rather than the junk. 
    //Level 2
    //You have the power to control the player with the help of your mouse. Try your best to not touch the
    //bacteria. "Your health is your real wealth." ALL THE BEST!!     
  }
  ...
  if (gameState === "know") {
    ...
    strokeWeight(2)
    fill("yellow")
    text("                           FACTS !!! \n1)Processed food is designed to get you addicted.\n\n2)There are insect secretions in your candy.\n\n3)Natural Flavors aren't really that natural.\n\n  4) French fries, fried chicken, and onion rings are\n     particularly harmful.\n\n  5) Pizza Hut uses over 300 million pounds of \n    cheese per year.", (popbox.x - (popbox.width / 1.6)), 80)
